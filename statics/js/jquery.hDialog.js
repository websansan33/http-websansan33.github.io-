...
;(function(factory){
    ...
    var methods = {
      ...
      init: function(options) {
        ...
        return this.each(function(i) {
            var defaults = {
              title: '',                //弹框标题
              box: '#HBox',               //弹框默认选择器
              boxBg: '#eeeeee',           //弹框默认背景颜色
              modalBg: 'rgba(0,0,0,0.5)', //遮罩默认背景颜色
              width: '100%',              //弹框默认宽度
              height: '30%',              //弹框默认高度
              positions: 'center',        //弹框位置(默认center：居中，top：顶中，left：顶左，bottom：底右)
              ...
              isOverlay: false,           //是否显示遮罩背景(默认true：显示，false：不显示)
      ...
      open: function($el) {
        ...
        m = "" + parseInt(-(h/2)) + 'px 0 0 ' + parseInt(-(w/2)) + "px"; //margin
        ...
        $('.tabbody').off("click").on("click", function (e) {
