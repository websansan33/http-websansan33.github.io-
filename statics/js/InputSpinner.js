...
// quantity-wrapper form-group
        var html = '<div class="input-group input-group-option' + config.groupClass + '">' +
        //input-group-addon input-group-addon-remove quantity-remove btn btn-decrement
            '<span class="input-group-addon btn btn-decrement ' + config.buttonsClass + '" style="min-width: ' + config.buttonsWidth + '">' +
'<span class="glyphicon glyphicon-minus"></span>'+
            '</span>' +
            '<input type="text" style="text-align: ' + config.textAlign + '" class="form-control quantity-count ' + config.inputClass + '"/>' +
            //input-group-addon input-group-addon-remove quantity-add btn btn-increment
            '<span class="input-group-addon btn btn-increment ' + config.buttonsClass + '" style="min-width: ' + config.buttonsWidth + '">' +
