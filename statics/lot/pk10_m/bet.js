...
isDD=(m==11||m==13)&&true;else
isDD=(m==11||m==13)&&false;for(var i=0;i<s.length;i++)
...
{var temp=tmp.join("|");re=/(\[[^\]]*\])|[ \t\r\n]+/g;temp=temp.replace(re,"");if(temp=="")
...
{n1=addZero(getRndNum(1,10));n2=addZero(getRndNum(1,10));n3=addZero(getRndNum(1,10));n4=addZero(getRndNum(1,10));n5=addZero(getRndNum(1,10));n6=addZero(getRndNum(1,10));n7=addZero(getRndNum(1,10));n8=addZero(getRndNum(1,10));n9=addZero(getRndNum(1,10));n10=addZero(getRndNum(1,10));temp=n1;while(n2==n1)n2=addZero(getRndNum(1,10));temp+="|"+n2;while(temp.indexOf(n3)>=0)n3=addZero(getRndNum(1,10));temp+="|"+n3;while(temp.indexOf(n4)>=0)n4=addZero(getRndNum(1,10));temp+="|"+n4;while(temp.indexOf(n5)>=0)n5=addZero(getRndNum(1,10));temp+="|"+n5;while(temp.indexOf(n6)>=0)n6=addZero(getRndNum(1,10));temp+="|"+n6;while(temp.indexOf(n7)>=0)n7=addZero(getRndNum(1,10));temp+="|"+n7;while(temp.indexOf(n8)>=0)n8=addZero(getRndNum(1,10));temp+="|"+n8;while(temp.indexOf(n9)>=0)n9=addZero(getRndNum(1,10));temp+="|"+n9;while(temp.indexOf(n10)>=0)n10=addZero(getRndNum(1,10));temp+="|"+n10;switch(nam)
{case"猜冠军":temp=n1;break;case"猜冠亚军":temp=n1+"|"+n2;break;case"猜前三名":temp=n1+"|"+n2+"|"+n3
break;case"猜前四名":temp=n1+"|"+n2+"|"+n3+"|"+n4
break;case"猜前五名":temp=n1+"|"+n2+"|"+n3+"|"+n4+"|"+n5
break;case"猜前六名":temp=n1+"|"+n2+"|"+n3+"|"+n4+"|"+n5+"|"+n6;break;case"猜前七名":temp=n1+"|"+n2+"|"+n3+"|"+n4+"|"+n5+"|"+n6+"|"+n7;break;case"猜前八名":temp=n1+"|"+n2+"|"+n3+"|"+n4+"|"+n5+"|"+n6+"|"+n7+"|"+n8;break;case"猜前九名":temp=n1+"|"+n2+"|"+n3+"|"+n4+"|"+n5+"|"+n6+"|"+n7+"|"+n8+"|"+n9;break;case"猜前十名":temp=n1+"|"+n2+"|"+n3+"|"+n4+"|"+n5+"|"+n6+"|"+n7+"|"+n8+"|"+n9+"|"+n10;break;case"十星定位胆":temp=n1+"|"+n2+"|"+n3+"|"+n4+"|"+n5+"|"+n6+"|"+n7+"|"+n8+"|"+n9+"|"+n10;break;case"前五定位胆":temp=n1+"|"+n2+"|"+n3+"|"+n4+"|"+n5;break;case"后五定位胆":temp=n1+"|"+n2+"|"+n3+"|"+n4+"|"+n5;break;case"龙虎冠军":case"龙虎亚军":case"龙虎季军":case"龙虎第四名":case"龙虎第五名":case"龙虎冠亚军":n11=getRndNum(0,1);var mapName=["龙","虎"];temp=mapName[n11];break;}
...
{case"[猜冠军]":reZ=selpk10(xNum,1);break;case"[猜冠亚军]":reZ=selpk10(xNum,2);break;case"[猜前三名]":reZ=selpk10(xNum,3);break;case"[猜前四名]":reZ=selpk10(xNum,4);break;case"[猜前五名]":reZ=selpk10(xNum,5);break;case"[猜前六名]":reZ=selpk10(xNum,6);break;case"[猜前七名]":reZ=selpk10(xNum,7);break;case"[猜前八名]":reZ=selpk10(xNum,8);break;case"[猜前九名]":reZ=selpk10(xNum,9);break;case"[猜前十名]":reZ=selpk10(xNum,10);break;case"[十星定位胆]":case"[前五定位胆]":case"[后五定位胆]":var numArray=xNum.split("|");reZ=0;for(var i=0;i<numArray.length;i++)
{reZ+=(numArray[i]=="")?0:numArray[i].split(",").length;}
break;case"[龙虎冠军]":case"[龙虎亚军]":case"[龙虎季军]":case"[龙虎第四名]":case"[龙虎第五名]":case"[龙虎冠亚军]":reZ=selpk10(xNum,1);break;default:bootbox.alert("错误的彩票标识名,请与管理员联系");reZ=0;}
return reZ;}
